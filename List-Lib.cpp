#ifndef _LIST_LIB_CPP
#define _LIST_LIB_CPP
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
LIST *CreateList (long n)
{
	...
	NewList = (LIST *)calloc(sizeof(LIST), 1);
...
int InsertEntry(LIST *List, void *Data, unsigned long Size, int(*function)(void *Data1, void *Data2))
{
	...
	if((NewEntry = (entry_t *)calloc(sizeof(entry_t), 1)) == NULL)
		return 0;

	if((NewData = calloc(Size, 1)) == NULL)
		return 0;
